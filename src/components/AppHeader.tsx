        ...
        <div className="relative container flex items-center justify-between py-4">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-2 mb-1">
              {logoUrl ? (
                <img src={logoUrl} alt={shopName} className="h-8 w-8 rounded-lg object-cover bg-accent/20" />
              ) : (
                <div className="h-8 w-8 rounded-lg bg-accent/20 flex items-center justify-center">
                  <Wrench className="h-4 w-4 text-accent" />
                </div>
              )}
              <h1 className="text-xl font-bold text-header-foreground tracking-wide">{shopName}</h1>
            </div>
